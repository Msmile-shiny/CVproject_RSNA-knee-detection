# ============================================================
# v4: Training Loop — EMA + Early Stopping + 最佳模型保存
# ============================================================
...
print(f'  FocalLoss(α={CFG["focal_alpha"]}, γ={CFG["focal_gamma"]}) | EMA({CFG["ema_decay"]})')
print(f'  ★ Physical crop: {CFG["crop_mm"]}mm | Laterality norm | Spatial ordering')
print()
